...
public class GlobalRefDatabaseTest extends AbstractDaemonTest {
  ...
  public void shouldCreateGenericEntryInTheGlobalRefDBWhenFirstValue() {
    assertThat(objectUnderTest.compareAndPut(project, nullRef, null, new Object())).isTrue();
  }
  ...
  public void shouldUpdateGenericEntryWithNewRef() throws Exception {
    ...
    objectUnderTest.compareAndPut(project, ref, null, object1);

    Object object2 = new Object();
    assertThat(objectUnderTest.compareAndPut(project, ref, object1, object2)).isTrue();
  }
  ...
  public void shouldRejectGenericUpdateWhenLocalRepoIsOutdated() throws Exception {
    ...
    assertThat(objectUnderTest.compareAndPut(project, ref, object2, object3)).isFalse();
  }
