...
/** Removes a project from the shared ref-db upon deletion */
public class ProjectDeletedSharedDbCleanup implements ProjectDeletedListener {
   ...
   * shared ref-database
   *
   * @param sharedDb Shared ref-db used to validate project deletion
  ...
  /**
   * Attempts to delete a prject from the shared ref-db. Upon failure, it swallows {@link
