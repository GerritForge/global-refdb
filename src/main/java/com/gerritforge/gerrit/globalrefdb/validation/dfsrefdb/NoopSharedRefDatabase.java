 ...
 * independently from any additional plugins or the existence of a specific Ref-DB installation.
 */
public class NoopSharedRefDatabase implements GlobalRefDatabase {
  ...
  /**
   * Always return an empty object as to never be considered existing in the shared ref-db.
   *
   * @param project project name
